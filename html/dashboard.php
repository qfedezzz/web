...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($stmt->execute()) {
        // echo "¡Datos actualizados correctamente!"; // Eliminar esta línea para no mostrar el mensaje
    } else {
...
<head>
    ...
    <style>
        ...
        /* Ajustes para la sección adicional */
.seccion-adicional {
    width: 50%; /* Ajustar el ancho de la sección */
    margin-left: 5%; /* Espacio a la izquierda */
    display: flex;
    flex-direction: column;
...
.seccion-adicional input {
    width: 100%; /* Hacer que los inputs y selects ocupen todo el ancho disponible */
    padding: 12px;
    margin-bottom: 18px;
    border: 1px solid #333;
    border-radius: 5px;
...
.boton-home {
    width: 100%; /* Hacer que el botón de Home ocupe todo el ancho disponible */
    padding: 14px;
    background: #1a1a1a;
    border: none;
    border-radius: 5px;
...
/* Efecto al hacer hover en el botón de Home */
.boton-home:hover {
    background: #00FF00;
    color: #000;
    transform: scale(1.05);
    ...
    <div class="menu-usuario">
        ...
        <div class="datos-usuario">
            ...
            <form method="POST" enctype="multipart/form-data">
                    ...
                    <a href="recuperar_contraseña.php" class="enlace-recuperar">¿Olvidaste tu contraseña?</a>
                </div>
                </div>
                ...
                <div class="seccion-adicional">
                    ...
                    <!-- Sección de idioma y equipo favorito -->
